...
#|
I guess that the time to test primes near 1000000 will be a few times as long
as testing for primes near 1000.
But actually, they cost almost the same.
May be it depends on the randome positive number.
|#